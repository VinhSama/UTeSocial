...
import com.utesocial.android.core.presentation.main.element.partial.MainPartialBottom
import com.utesocial.android.core.presentation.main.element.partial.MainPartialScreen
import com.utesocial.android.core.presentation.main.element.partial.MainPartialSearch
import com.utesocial.android.core.presentation.main.element.partial.MainPartialTop
...
class MainActivity : BaseActivity() {
    ...
    private val bottomBinding by lazy { MainPartialBottom(this@MainActivity, binding.bottomBar) }
    private val screenBinding by lazy { MainPartialScreen(this@MainActivity, binding.screen) }
    private val searchBinding by lazy { MainPartialSearch(this@MainActivity, binding.search) }
    private val topBinding by lazy { MainPartialTop(this@MainActivity, binding.topBar) }
    ...
    private fun setSplashScreenExit(splashScreen: SplashScreen) = splashScreen.setOnExitAnimationListener { splashScreenViewProvider ->
        AnimatorInflater.loadAnimator(this@MainActivity, R.animator.animator_splash_screen_exit).apply {
    ...
    private fun setup(splashScreen: SplashScreen) {
        ...
        NavigationUICustom.setupWithNavController(
            ...
            animEnter = R.anim.anim_bottom_nav_enter,
            animExit = R.anim.anim_bottom_nav_exit,
            animPopEnter = R.anim.anim_bottom_nav_enter,
            animPopExit = R.anim.anim_bottom_nav_exit,
            animatorEnter = R.animator.animator_bottom_nav_enter,
            animatorExit = R.animator.animator_bottom_nav_exit,
            animatorPopEnter = R.animator.animator_bottom_nav_enter,
            animatorPopExit = R.animator.animator_bottom_nav_exit,
            R.id.fra_notification, R.id.fra_settings
        )
